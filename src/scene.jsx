...
import { AccumulativeShadows, Environment, Lightformer, useGLTF } from "@react-three/drei";
...
export const Scene = ({ mainColor, path, ...props }) => {
  ...
  useEffect(() => {
    // Traverse through each object to cast shadows
  ...
  return (
    <>
      ...
      <group {...props} dispose={null}>
        ...
        {/* Lights */}
        <pointLight position={[0, 5, 0]} intensity={1.5} distance={10} decay={2} castShadow />
        <ambientLight intensity={0.5} />

        {/* Accumulative Shadows and RandomizedLight */}
        <AccumulativeShadows
          frames={100}
          alphaTest={0.6}
          scale={30}
          ...
          opacity={0.8}
        >
          <RandomizedLight amount={4} radius={9} intensity={10} ambient={0.25} position={[10, 5, 15]} />
        </AccumulativeShadows>

        {/* Environment with Sphere background */}
